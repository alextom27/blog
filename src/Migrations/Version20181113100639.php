 ...
 */
final class Version20181113100639 extends AbstractMigration
{
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE article.html.twig ADD category_id INT NOT NULL');
        $this->addSql('ALTER TABLE article.html.twig ADD CONSTRAINT FK_23A0E6612469DE2 FOREIGN KEY (category_id) REFERENCES category.html.twig (id)');
